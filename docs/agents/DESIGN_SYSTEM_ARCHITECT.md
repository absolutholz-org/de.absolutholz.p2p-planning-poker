...
- **No className Props:** Do not add `className` props to components. This ensures styles remain encapsulated and prevents external overrides that break design consistency.
