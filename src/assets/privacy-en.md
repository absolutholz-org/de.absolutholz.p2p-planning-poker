...
To enable connections behind firewalls, we use STUN/TURN servers provided by Metered.ca. Connection data (including IP addresses) may be routed through servers outside the EU (e.g., Canada or the USA). The EU Commission has issued an adequacy decision for Canada. For data transfers to other third countries, we have entered into Standard Contractual Clauses (SCCs) pursuant to Art. 46 GDPR with the provider to ensure an adequate level of data protection. A Data Processing Agreement (DPA) pursuant to Art. 28 GDPR has also been concluded.
