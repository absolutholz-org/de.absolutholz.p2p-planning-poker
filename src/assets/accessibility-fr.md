# Déclaration d'Accessibilité pour P2P Planning Poker

## Notre Objectif

P2P Planning Poker s'engage à garantir l'accessibilité numérique à tous les utilisateurs, quelles que soient leurs capacités. Notre objectif est d'atteindre une conformité totale avec les normes **WCAG 2.2 Niveau AA** et **BITV 2.0**.

## État Actuel

Nous sommes actuellement dans une phase de « Développement et de Mise aux Normes ». Bien que notre plateforme ne soit pas encore totalement conforme, nous donnons la priorité à l'accessibilité dans notre architecture de base.

### Notre Approche de la Conception Inclusive
